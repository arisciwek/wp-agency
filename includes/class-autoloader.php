<?php
/**
 * Enhanced Autoloader for WP Agency Plugin
 *
 * @package     WP_Agency
 * @subpackage  Includes
 * @version     1.0.7
 * @author      arisciwek
 *
 * Path: /wp-agency/includes/class-autoloader.php
 *
 * Description: Advanced autoloader untuk WP Agency plugin.
 ...
 * $autoloader = new WPAgencyAutoloader('WPAgency\\', plugin_dir_path(__FILE__));
 * $autoloader->register();
 *
 * Changelog:
 * 1.0.0 - 2024-02-11
