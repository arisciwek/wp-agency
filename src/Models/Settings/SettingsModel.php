 ...
 * Path: /wp-agency/src/Models/Settings/SettingsModel.php
...
class SettingsModel {
    private $option_group = 'wp_agency_settings';
    private $general_options = 'wp_agency_general_options';
    ...
    public function registerSettings() {
        ...
        register_setting(
            'wp_agency_options', // Option group
            'wp_agency_settings', // Option name
            [
                'type' => 'array',
        ...
        add_settings_section(
            'wp_agency_general_section',
            __('Pengaturan Umum', 'wp-agency'),
        ...
        add_settings_field(
            ...
            [
                ...
                'desc' => __('Jumlah data yang ditampilkan per halaman (5-100)', 'wp-agency')
            ]
        );

        add_settings_field(
            'enable_caching',
            __('Aktifkan Cache', 'wp-agency'),
            ...
            [
                ...
                'desc' => __('Aktifkan caching untuk performa lebih baik', 'wp-agency')
            ]
        );

        add_settings_field(
            'cache_duration',
            __('Durasi Cache', 'wp-agency'),
            ...
            [
                ...
                'desc' => __('Berapa lama cache disimpan', 'wp-agency'),
                'options' => [
                    3600 => __('1 jam', 'wp-agency'),
                    7200 => __('2 jam', 'wp-agency'),
                    21600 => __('6 jam', 'wp-agency'),
                    43200 => __('12 jam', 'wp-agency'),
                    86400 => __('24 jam', 'wp-agency')
                ]
            ]
        );
    }
    ...
    public function getGeneralOptions(): array {
        $cache_key = 'wp_agency_general_options';
        $cache_group = 'wp_agency';
    ...
    public function saveGeneralSettings(array $input): bool {
        ...
        // Clear cache first
        wp_cache_delete('wp_agency_general_options', 'wp_agency');
 ...
 */
    ...
    public function renderGeneralSection() {
        echo '<p>' . __('Pengaturan umum untuk plugin WP Agency.', 'wp-agency') . '</p>';
    }
    ...
    public function renderNumberField($args) {
        ...
        printf(
            '<input type="number" id="%1$s" name="wp_agency_general_options[%1$s]" value="%2$s" class="regular-text">',
    ...
    public function renderCheckboxField($args) {
        ...
        printf(
            '<input type="checkbox" id="%1$s" name="wp_agency_general_options[%1$s]" value="1" %2$s>',
            esc_attr($args['field_id']),
            $checked
        );
    ...
    public function renderSelectField($args) {
        ...
        printf('<select id="%s" name="wp_agency_general_options[%s]">', 
            esc_attr($args['field_id']),
            esc_attr($args['field_id'])
        );
