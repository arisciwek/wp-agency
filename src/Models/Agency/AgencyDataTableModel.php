...
class AgencyDataTableModel extends AbstractDataTable {
    ...
    /**
     * Get columns for SQL SELECT query
     *
     * Required by AbstractDataTable for building SELECT clause.
     * All columns properly aliased to prevent SQL injection.
     *
     * @return array Array of column names with aliases
     */
