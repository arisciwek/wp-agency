 ...
 * @author      arisciwek
 *
 * Path: /wp-agency/src/Views/templates/company/company/company-dashboard.php
 *
...
<div class="wrap">
    ...
    <div class="wp-company-content-area">
        <div id="wp-company-main-container" class="wp-company-container">
            <!-- Left Panel -->
            <?php require_once WP_AGENCY_PATH . 'src/Views/templates/company/company-left-panel.php'; ?>

            <!-- Right Panel -->
            <div id="wp-company-right-panel" class="wp-company-right-panel hidden">
                <?php require_once WP_AGENCY_PATH . 'src/Views/templates/company/company-right-panel.php'; ?>
            </div>
        </div>
    </div>
</div>
