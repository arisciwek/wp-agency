<?php
/**
 * Agency Membership Tab Template
 *
 * @package     WP_Agency
 ...
 * @author      arisciwek
 *
 * Description: Template for displaying agency membership information
...
<div id="membership-info" class="tab-content">
    ...
    <div class="postbox membership-status-card">
        ...
        <div class="inside">
            ...
            <div class="staff-usage-section">
                <h4><?php _e('Penggunaan Staff', 'wp-agency'); ?></h4>
            ...
            <div class="capabilities-section">
                <h4><?php _e('Fitur Aktif', 'wp-agency'); ?></h4>
                <ul id="active-capabilities" class="capability-list"></ul>
            </div>

            <!-- Period Information -->
            <div class="period-section">
                <h4><?php _e('Periode Membership', 'wp-agency'); ?></h4>
                <table class="form-table">
                    <tr>
                        <th><?php _e('Mulai', 'wp-agency'); ?></th>
                        <td><span id="membership-start-date">-</span></td>
                    </tr>
                    <tr>
                        <th><?php _e('Berakhir', 'wp-agency'); ?></th>
    ...
    <div class="postbox">
        <h3 class="hndle">
            ...
            <?php _e('Level Membership', 'wp-agency'); ?>
        </h3>
        <div class="inside">
