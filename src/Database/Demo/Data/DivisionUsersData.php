...
class DivisionUsersData {
    ...
    public static $data = [
        1 => [  // Disnaker Provinsi Aceh
            'pusat' => ['id' => 140, 'username' => 'budi_citra', 'display_name' => 'Budi Citra', 'role' => ['agency', 'agency_admin_unit']],
        ...
        2 => [  // Disnaker Provinsi Sumatera Utara
            'pusat' => ['id' => 143, 'username' => 'hendra_indah', 'display_name' => 'Hendra Indah', 'role' => ['agency', 'agency_admin_unit']],
        ...
        3 => [  // Disnaker Provinsi Sumatera Barat
            'pusat' => ['id' => 146, 'username' => 'nando_omar', 'display_name' => 'Nando Omar', 'role' => ['agency', 'agency_admin_unit']],
        ...
        4 => [  // Disnaker Provinsi Banten
            'pusat' => ['id' => 149, 'username' => 'usman_vina', 'display_name' => 'Usman Vina', 'role' => ['agency', 'agency_admin_unit']],
        ...
        5 => [  // Disnaker Provinsi Jawa Barat
            'pusat' => ['id' => 152, 'username' => 'budi_dani', 'display_name' => 'Budi Dani', 'role' => ['agency', 'agency_admin_unit']],
        ...
        6 => [  // Disnaker Provinsi Jawa Tengah
            'pusat' => ['id' => 155, 'username' => 'gita_indah', 'display_name' => 'Gita Indah', 'role' => ['agency', 'agency_admin_unit']],
        ...
        7 => [  // Disnaker Provinsi Jawa Timur
            'pusat' => ['id' => 158, 'username' => 'nando_putri', 'display_name' => 'Nando Putri', 'role' => ['agency', 'agency_admin_unit']],
        ...
        8 => [  // Disnaker Provinsi Kalimantan Barat
            'pusat' => ['id' => 161, 'username' => 'tono_vina', 'display_name' => 'Tono Vina', 'role' => ['agency', 'agency_admin_unit']],
        ...
        9 => [  // Disnaker Provinsi Kalimantan Timur
            'pusat' => ['id' => 164, 'username' => 'budi_gita', 'display_name' => 'Budi Gita', 'role' => ['agency', 'agency_admin_unit']],
        ...
        10 => [  // Disnaker Provinsi Sulawesi Selatan
            'pusat' => ['id' => 167, 'username' => 'eko_joko', 'display_name' => 'Eko Joko', 'role' => ['agency', 'agency_admin_unit']],
