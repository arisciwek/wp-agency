...
* @author      arisciwek
* 
* Path: /wp-agency/src/Database/Tables/AgencyMembershipLevelsDB.php
*
...
* - AgencyMembershipFeaturesDB untuk referensi feature groups
*
* Changelog:
* 1.0.2 - 2025-02-14
...
class AgencyMembershipLevelsDB {
    /**
     * Get database schema
