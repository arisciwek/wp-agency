...
* @author      arisciwek
* 
* Path: /wp-agency/src/Database/Tables/AgencyMembershipFeaturesDB.php
* 
...
class AgencyMembershipFeaturesDB {
    ...
    public static function get_schema() {
        ...
        // Tabel untuk groups
        $table_groups = $wpdb->prefix . 'app_agency_membership_feature_groups';
        $table_features = $wpdb->prefix . 'app_agency_membership_features';
