 ...
 * @author      arisciwek
 *
 * Path: /wp-agency/assets/js/settings/demo-data-tab-script.js
 *
...
jQuery(document).ready(function($) {
    ...
    function checkDependencies() {  
        $('.agency-generate-demo-data[data-requires]').each(function() {
            const button = $(this);
    ...
    function checkTypeGenerated(type) {
        ...
        const relatedButton = $(`.agency-generate-demo-data[data-type="${type}"]`);
        return relatedButton.prop('disabled');
    }

    $('.agency-generate-demo-data').on('click', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'agency_generate_demo_data',
                type: type,
                nonce: nonce
            },
