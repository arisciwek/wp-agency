 ...
 * @author      arisciwek
 *
 * Path: /wp-agency/assets/js/audit-log/audit-log.js
 *
...
(function($) {
    ...
    function initAuditLogDataTable() {
        ...
        if (!agencyId) {
            console.error('[Audit Log] agency-id not found');
            return;
        }
    ...
    function showAuditDetailModal(data) {
        ...
        comparisonHTML += '<thead><tr><th>' + wpAgencyAuditLog.i18n.field + '</th><th>' + wpAgencyAuditLog.i18n.oldValue + '</th><th>' + wpAgencyAuditLog.i18n.newValue + '</th></tr></thead>';
        ...
        if (typeof WPModal !== 'undefined') {
            WPModal.show({
                type: 'info',
                title: wpAgencyAuditLog.i18n.detailTitle,
                body: comparisonHTML,
                size: 'large',
                buttons: {
                    close: {
                        label: wpAgencyAuditLog.i18n.close,
                        primary: false
                    }
                }
            });
        } else {
            alert(wpAgencyAuditLog.i18n.modalLibraryNotLoaded);
        }
    }
